                                ...
                                <ul class="nav nav-tabs nav-justified">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Contacts-info" data-toggle="tab" href="#active"
                                            aria-controls="active" aria-expanded="true">Create Contacts</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link disable" id="Contacts-info">Edit Contacts</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Contacts-info" href="{{route('ContactList')}}">List Contacts</a>
                                    </li>
                                </ul>
                                {{-- tab 1 --}}
                                <div class="tab-content px-1 pt-1">
                                    <div role="tabpanel" class="tab-pane active" id="active" aria-labelledby="Product-info"
                                        aria-expanded="true">
