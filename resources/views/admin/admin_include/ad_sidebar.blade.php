<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Contacts</span></a>
          <ul class="menu-content">
            <li class=" nav-item"><a href="#"><i class="la la-television"></i>Add new Contacts</a></li>
            <li class=" nav-item"><a href="{{ route('ContactList') }}"><i class="la la-television"></i>Contact Lists</a></li>
          </ul>
        </li>
